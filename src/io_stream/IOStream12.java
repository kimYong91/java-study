...
public class IOStream12 {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        String filePath = "src/io_stream/object_IOStream12.dat";
        // 객체기반 스트림에 - 객체 보조 스트림 연결
