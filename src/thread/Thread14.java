...
public class Thread14 {
    // 생산자 - 소비자 모델 : 디자인 패턴
    // 생산자 Producer : 데이터를 생성하고, 버퍼에 추가 / 버퍼가 가득 차있으면 대기
    // 소비자 Consumer : 버퍼에서 데이터를 꺼내서 사용 / 버퍼가 비어있으면 대기
    // 버퍼 : 생상자가 생성한 데이터를 임시로 저장하는 공간. (유한한 공간)
    public static void main(String[] args) {
        ...
        customerlist.stream()
                .forEach(customer ->
                    new Thread(new Customer(customer, coffeeMachine)).start());
