...
/*
    ...
    문제 설명:
    두 명의 마법사가 듀얼을 벌입니다. 각 마법사는 번갈아 가며 마법을 사용하며, 각자 다른 시간 간격으로 마법을 사용할 수 있습니다. 마법사 A는 1초마다 불 마법을, 마법사 B는 1.5초마다 얼음 마법을 사용합니다. 듀얼은 총 10초 동안 진행되며, 각 마법사가 마법을 사용할 때마다 사용한 마법과 그 시간을 출력합니다.
