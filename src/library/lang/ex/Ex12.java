...
public class Ex12 {
    ...
    private static void extracted(String residentNumber) {
        if (!(residentNumber.length() == 14) || !residentNumber.contains("-")) {
            throw new IllegalArgumentException("입력 형식은 \"YYMMDD-XXXXXXX\"입니다.");
        }
    }
}
/*
