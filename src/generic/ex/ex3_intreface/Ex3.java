...
public class Ex3 {
        public static void main(String[] args) {
           DataProcessor<Integer> dataProcessor = new NumberDataProcessor();
           DataProcessor<String> dataProcessor1 = new StringDataProcessor();

            System.out.println(dataProcessor.processData(100));
            System.out.println(dataProcessor1.processData("hello, java"));
        }
}
/*
