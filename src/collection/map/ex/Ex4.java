...
public class Ex4 {
    ...
    public static void main(String[] args) {
        Map<Integer, Employee> worker = new HashMap<>();
        worker.put(1, new Employee("001", "Alice", "개발"));
        worker.put(2, new Employee("002", "Bob", "디자인"));
        worker.put(3, new Employee("003", "Charlie", "마케팅"));

        worker.putIfAbsent(4, new Employee("003","아이디 같음", "마케팅"));
        worker.putIfAbsent(5, new Employee("004","noName", "마케팅"));

        for (Map.Entry<Integer, Employee> integerEmployeeEntry : worker.entrySet()) {
 ...
 /*
    ...
    이 시스템은 직원의 ID를 키로, 직원 정보를 값으로 하는 Map을 사용하여 직원들의 정보를 저장하고 관리합니다.
