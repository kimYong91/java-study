...
public class Static1 {
    ...
    // 스택에 메인 메서드 프레임이 생성된다.
    public static void main(String[] args) {

        System.out.println("메인 메서드 시작");
        staticMethod1();                          // 스태틱 메서드1 호출 -> 스택 프레임 생성
    ...
    static void staticMethod1() {
        ...
        staticMethod2(data);                     // 스택 영역에 메서드 호출 + 스택 프레임 생성
        // 메서드 2 스택 프레임의 매개변수로 data의 참조값을 복사하여 전달
        System.out.println("메서드1 끝");
        // 메서드1 스텍 프레임이 제거된다. data 변수도 프레임과 함께 제거
        // 더 이상 data(100) 객체를 참조하는 변수가 하나도 남아 있지않게 됨
        // GC가 객체도 제거하게 된다.
    }
    ...
    static void staticMethod2(Data dataParam) {
        ...
        // 메서드 영역(공유) 의 data 클래스의 getField 메서드 코드레 접근한다.
