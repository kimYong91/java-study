...
public class ClassClass {
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        // Class 클래스는 글래스에 대한 메다 데이터, 다양한 데이터를 조회하고, 조작, 관리

        // Class 객체 얻는 방법
        // 1. 클래스 이름.class
        Class<String> stringClass = String.class;

        // 2. Class.forName("패키지를 포함한..정식 클래스 이름")
        ...
        // 클래스 전체 이름 반환
        System.out.println("클래스 이름: " + stringClass);
        // 부모 클래스 및 이름 반환 (메서드 체이닝 기법)
        System.out.println("부모 클래스 이름: " + stringClass.getSuperclass().getName());
        ...
        /*
        Reflection 주의 사항
        프레임워크를 새로 개발하거나, 컴파일 시점이 아닌 런타이에서 클래스와 상호작용할 때 매우 유용히 사용할 수 있음.
