...
public class Set5 {
    ...
    Comparable 이 구현되었거나, Comparator 를 통해 순서를 학인할 수 없으면
    TreeSet 에 요소로 추가할 수 없음
     */
    public static void main(String[] args) {
        ...
        treeSet.add(36);
        treeSet.add(5);     // 중복 불가
        // treeSet.add(null);     // null 불가 (Runtime Exception)
        ...
        // 10보다 heaS(왼쪽, 작은) 숫자들의 집합을 반환 (요소 불포함)
        ...
        stringTreeSet.addAll(Arrays.asList("가", "나", "하", "다", "자"));
        System.out.println("stringTreeSet = " + stringTreeSet);
    }
}